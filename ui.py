...
def normalize_values(points,disp):
    if(abs(disp - np.min(points))/abs(np.max(points) - np.min(points))) > 0.0:
...
def login():
    ...
    if request.method == "POST":
        ...
        elif(final_stress_value > 40 and final_stress_value <=50):
           submittion_status = 3        
        elif(final_stress_value > 50 and final_stress_value <=60):
            submittion_status = 4       
        elif(final_stress_value > 60 and final_stress_value <=70):
            submittion_status = 5       
        elif(final_stress_value > 70 and final_stress_value <=80):
            submittion_status = 6       
        elif(final_stress_value > 80 and final_stress_value <=90):
            submittion_status = 7       
        elif(final_stress_value > 90):    
            submittion_status = 8 
...
def upload_file():
    ...
    if(submittion_status == 3):
        return render_template('remedy1.html')
        
    if(submittion_status == 4):
        return render_template('remedy2.html')
    
    if(submittion_status == 5):
        return render_template('remedy3.html')
        
    if(submittion_status == 6):
        return render_template('remedy4.html')
    
    if(submittion_status == 7):
        return render_template('remedy5.html')    
    
    if(submittion_status == 8):
        return render_template('remedy6.html')  
